...
function generate_data(D, N, sigma, lambda, folder)
    file_x_train = string(folder, "/x_train_", D, "_", N, "_", sigma, "_", lambda, ".txt")
    file_x_test = string(folder, "/x_test_", D, "_", N, "_", sigma, "_", lambda, ".txt")
    file_y_train = string(folder, "/y_train_", D, "_", N, "_", sigma, "_", lambda, ".txt")
    file_y_test = string(folder, "/y_test_", D, "_", N, "_", sigma, "_", lambda, ".txt")
    file_params = string(folder, "/true_parameters_", D, "_", N, "_", sigma, "_", lambda, ".txt")
...
function get_model(D, N, sigma, lambda, folder)
    x_train = readdlm(string(folder, "/x_train_", D, "_", N, "_", sigma, "_", lambda, ".txt"))
    x_test = readdlm(string(folder, "/x_test_", D, "_", N, "_", sigma, "_", lambda, ".txt"))
    y_train = vec(readdlm(string(folder, "/y_train_", D, "_", N, "_", sigma, "_", lambda, ".txt")))
    y_test = vec(readdlm(string(folder, "/y_test_", D, "_", N, "_", sigma, "_", lambda, ".txt")))
    theta_true = vec(readdlm(string(folder, "/true_parameters_", D, "_", N, "_", sigma, "_", lambda, ".txt")))
