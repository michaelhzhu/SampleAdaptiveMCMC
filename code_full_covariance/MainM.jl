...
function main()
    ...
    if args["run_sa"]
        args["s"] = "$(model_str)_safull_$(N)_$(q0_std)_$(args["mixture_coef_str"])_$(args["mixture_prob_str"])_$(args["trial"])"
    elseif args["run_mh"]
        args["s"] = "$(model_str)_mh_$(q_std)_$(args["trial"])"
    elseif args["run_am"]
        args["s"] = "$(model_str)_amfull_$(args["adaptive_scale"])_$(q_std)_$(args["trial"])"
    elseif args["run_mtm"]
